# downloaded from https://raw.githubusercontent.com/honzaskypala/osloveni/master/python/osloveni.py
...
def osloveni(jmeno):
    ...
    if replacepair[0] == '' and replacepair[1] == '':
        ...
        elif replaceending.istitle():
            return jmeno[:-len(replacepair[0])] + replacepair[1].title()
